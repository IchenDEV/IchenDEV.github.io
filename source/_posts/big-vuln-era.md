...
**Dirty Pipe、Copy Fail、Dirty Frag** 提醒我们，底层系统的一个逻辑细节，可能击穿 root 边界。**CVE-2026-42945** 提醒我们，流量入口同样不是安全地带。**Axios、XZ Utils、LiteLLM、TanStack** 提醒我们，可信依赖也可能在短时间内变成攻击载体。
