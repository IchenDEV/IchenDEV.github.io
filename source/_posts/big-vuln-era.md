...
| 2026 年 5 月 14 日（今日）| **node-ipc 信息窃取器** | 供应链投毒 | — | **极严重，刚刚曝光，DNS 隧道外传凭据** |
...
**Dirty Pipe、Copy Fail、Dirty Frag** 提醒我们，底层系统的一个逻辑细节，可能击穿 root 边界。**CVE-2026-42945** 提醒我们，流量入口同样不是安全地带。**Axios、XZ Utils、LiteLLM、TanStack、node-ipc** 提醒我们，可信依赖也可能在短时间内变成攻击载体——而且手法越来越精密，混淆越来越深，DNS 隧道这种出口方式连防火墙都难以察觉。
