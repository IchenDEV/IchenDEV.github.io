...
这些事件说明，**软件供应链已经从「代码质量问题」升级为「身份、发布、构建、依赖、运行环境」一起承受的风险**。
...
**Dirty Pipe、Copy Fail、Dirty Frag、Fragnesia** 提醒我们，底层系统的一个逻辑细节，可能击穿 root 边界。**CVE-2026-42945** 提醒我们，流量入口同样不是安全地带。**Axios、XZ Utils、LiteLLM、TanStack、node-ipc** 提醒我们，可信依赖也可能在短时间内变成攻击载体——而且手法越来越精密，混淆越来越深，DNS 隧道这种出口方式连防火墙都难以察觉。
