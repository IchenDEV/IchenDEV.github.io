...
这几个案例放在一起，揭示一个危险趋势：**攻击者一旦拿到普通权限，走向 root 的距离正在缩短**。容器、最小权限这些设计仍然有价値，但不能再被当成牢固的最后屏障。
...
**Dirty Pipe、Copy Fail、Dirty Frag、Fragnesia** 提醒我们，底层系统的一个逻辑细节，可能击穿 root 边界。**CVE-2026-42945** 提醒我们，流量入口同样不是安全地带。**Axios、XZ Utils、LiteLLM、TanStack、Apifox、node-ipc** 提醒我们，可信依赖也好、日常工具也好，都可能在短时间内变成攻击载体——而且手法越来越精密，混淆越来越混，DNS 隧道这种出口方式连防火墙都难以察觉。
